...
var decodeSignAndSubmit = function decodeSignAndSubmit(b64Txns, signTransactions, apiUrl) {
  try {
    var txnGroup = b64Txns.map(function (b64) {
      return algosdk.decodeUnsignedTransaction(Buffer.from(b64, 'base64'));
    });
...
function DepositPanel(_ref4) {
  ...
  var _useState2 = useState(pools[0] || null),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rfw-muted"
  }, "Checking vault status\u2026"), isOptedIn === false && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
    className: "rfw-muted",
    style: {
      marginBottom: 8
    }
  }, "You need to opt into this vault first."), error && /*#__PURE__*/React.createElement("p", {
    className: "rfw-error"
  }, error), /*#__PURE__*/React.createElement("button", {
    className: "rfw-btn rfw-btn-primary",
    onClick: handleOptIn
  }, "Opt In")), isOptedIn === true && /*#__PURE__*/React.createElement("form", {
...
function WithdrawPanel(_ref5) {
  ...
  }, "Deposited: ", formatTokenAmount(deposited), " ", assetName), error && /*#__PURE__*/React.createElement("p", {
    className: "rfw-error"
  }, error), /*#__PURE__*/React.createElement("button", {
    type: "submit",
...
function ClaimPanel(_ref6) {
  ...
  var _useState11 = useState(poolsWithYield[0] || null),
    selectedPool = _useState11[0],
    setSelectedPool = _useState11[1];
  var _useState12 = useState('confirm'),
    step = _useState12[0],
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Claimable"), /*#__PURE__*/React.createElement("span", {
    className: "rfw-claim-amount"
  }, formatTokenAmount(pending), " ", yieldAsset)), error && /*#__PURE__*/React.createElement("p", {
    className: "rfw-error"
  }, error), /*#__PURE__*/React.createElement("button", {
...
function ExitPanel(_ref8) {
  ...
  var _useState20 = useState(poolsWithPosition[0] || null),
    selectedPool = _useState20[0],
    setSelectedPool = _useState20[1];
  var _useState21 = useState('confirm'),
    step = _useState21[0],
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Deposit returned"), /*#__PURE__*/React.createElement("span", null, formatTokenAmount(pos.depositedAmount), " ", assetName)), (pos == null ? void 0 : pos.pendingYield) > 0 && /*#__PURE__*/React.createElement("div", {
    className: "rfw-exit-row"
  }, /*#__PURE__*/React.createElement("span", null, "Yield claimed"), /*#__PURE__*/React.createElement("span", null, formatTokenAmount(pos.pendingYield), " ", (selectedPool == null ? void 0 : selectedPool.swapAssetName) || 'ASA'))), /*#__PURE__*/React.createElement("p", {
    className: "rfw-warning"
  }, "This will close your position and opt you out of the vault."), error && /*#__PURE__*/React.createElement("p", {
    className: "rfw-error"
  }, error), /*#__PURE__*/React.createElement("button", {
...
function HistoryPanel(_ref9) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rfw-panel-title"
  }, "Yield History"), transactions.length === 0 && /*#__PURE__*/React.createElement("p", {
    className: "rfw-muted"
    ...
    }, label), tx.amount > 0 && /*#__PURE__*/React.createElement("span", {
      className: "rfw-history-amount"
    }, formatTokenAmount(tx.amount))), /*#__PURE__*/React.createElement("div", {
      className: "rfw-history-meta"
    }, /*#__PURE__*/React.createElement("span", null, poolLabel), tx.timestamp && /*#__PURE__*/React.createElement("span", null, new Date(tx.timestamp * 1000).toLocaleDateString()), /*#__PURE__*/React.createElement("a", {
...
function HomeView(_ref0) {
  ...
  }, positionsLoading ? /*#__PURE__*/React.createElement("p", {
    className: "rfw-muted"
  }, "Loading position\u2026") : hasDeposit || hasPendingYield ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "rfw-stat-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "rfw-stat-label"
  }, "Your Deposit"), /*#__PURE__*/React.createElement("span", {
    className: "rfw-stat-value"
  }, formatTokenAmount(totalDeposit), " ", assetName)), /*#__PURE__*/React.createElement("div", {
    className: "rfw-stat-row"
  }, /*#__PURE__*/React.createElement("span", {
    className: "rfw-stat-label"
  ...
  }).join(' · ') : '0')), activeVaults.length > 0 && /*#__PURE__*/React.createElement("div", {
  ...
  }, "No active position \u2014 deposit to start earning yield.")), /*#__PURE__*/React.createElement("div", {
...
function WidgetModal(_ref10) {
  ...
  var renderView = function renderView() {
    ...
    switch (view) {
      ...
      case 'history':
        return /*#__PURE__*/React.createElement(HistoryPanel, {
