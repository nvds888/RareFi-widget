...
function WithdrawPanel({
  ...
  const deposited = (position == null ? void 0 : position.depositedAmount) || 0;
...
function ClaimPanel({
  ...
  const [error, setError] = useState('');
  const position = selectedPool ? positions[selectedPool.id] : null;
  const pending = (position == null ? void 0 : position.pendingYield) || 0;
...
function HistoryPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const poolLabel = ((_tx$pool = tx.pool) == null ? void 0 : _tx$pool.poolType) === 'compound' ? assetName + ' Vault' : `${((_tx$pool2 = tx.pool) == null ? void 0 : _tx$pool2.swapAssetName) || 'ASA'} Vault`;
    return /*#__PURE__*/React.createElement("div", {
      key: tx.id,
...
function HomeView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rfw-stat-value"
  }, hasPendingYield ? Object.entries(pendingByToken).map(([token, amt]) => `${formatTokenAmount(amt)} ${token}`).join(' · ') : '0')), activeVaults.length > 0 && /*#__PURE__*/React.createElement("div", {
