(function (global, factory) {
  ...
  function decodeTxns(b64Txns) {
    return b64Txns.map(function (b64) {
      return algosdk__default["default"].decodeUnsignedTransaction(buffer.Buffer.from(b64, 'base64'));
    });
  }
  ...
  var abiSwap = new algosdk__default["default"].ABIContract(arc56Swap);
  var abiCompound = new algosdk__default["default"].ABIContract(arc56Compound);
  ...
  function SwitchPanel(_ref7) {
    ...
    var _useState19 = React.useState('select'),
      step = _useState19[0],
    ...
    }, "Amount to switch"), /*#__PURE__*/React__default["default"].createElement("span", {
      className: "rfw-balance-hint"
    }, "Deposited: ", /*#__PURE__*/React__default["default"].createElement("strong", null, formatTokenAmount(deposited), " ", assetName))), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "rfw-input-row"
    }, /*#__PURE__*/React__default["default"].createElement("input", {
  ...
  function ExitPanel(_ref8) {
    ...
    var _useState22 = React.useState(poolsWithPosition[0] || null),
      selectedPool = _useState22[0],
      setSelectedPool = _useState22[1];
    var _useState23 = React.useState('confirm'),
      step = _useState23[0],
  ...
  function YieldHistoryPanel(_ref0) {
    var userAddress = _ref0.userAddress,
      ...
      onBack = _ref0.onBack;
    var _useState26 = React.useState(true),
  ...
  function WidgetModal(_ref12) {
    ...
    var _useState29 = React.useState('home'),
      view = _useState29[0],
